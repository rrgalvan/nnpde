...
\begin{itemize}
  ...
  $$
  \item La función de coste varía con cada tipo de red neuronal. Por ejemplo, en problemas de regresión se suelen usar mínimos cuadrados:
    $$
...
\begin{frame}{Algoritmos de minimización}
  ...
  \begin{itemize}
    ...
    \item Se suelen utilizar algoritmos de tipo \alert{descenso de gradiente}
    \item Necesidad de derivar de forma eficiente: \alert{diferenciación automática}
    \item Algoritmos de \alert{gradiente estocástico}: en cada paso, se calcula el gradiente pero sólo en un subconjunto aleatorio de datos
  \end{itemize}
\end{frame}
